...
<div class="wrapper" style="padding: 20px; background-color: #f8f9fa;">
    <div class="container" id="signUpForm" style="margin: 150px auto 50px auto;">
        ...
        <!-- Alert for username and email errors -->
        <div id="username-email-alert-container" class="alert-container"></div>

        <div class="row">
            <div class="col-12 signUpField">
                <form method="POST" class="Post" id="signUpForm" onsubmit="return formValidator.validateForm()">
                    ...
                    <div id="password-alert-container" class="alert-container"></div>
    ...
    <?php
    include("../process/signUpValidation.php");
    ?>
</body>
