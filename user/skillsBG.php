                ...
                <div class="col-12 signUpField">
                    <form method="POST" class="Post">
                        <div class="mb-5 projectDetails">
                            <div class="col-12" id="portfolioContainer">
                                <div class="project-item">
                                    ...
                                    <input type="text" name="project-name[]" class="form-control projectName required"
                        ...
                        <div class="mb-3 skillDetail">
                            <label for="skillDesc" class="form-label required">Skills Description</label>
                        ...
                        <div class="modal fade" id="confirmationModal" tabindex="-1" aria-labelledby="confirmationLabel"
                            aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Are you sure you want to add a new portfolio? This action will allow you to
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn"
                                            style="background-color:rgb(81, 175, 76); color: #FFFFFF;"
                                            data-bs-dismiss="modal" onclick="addProject()">Yes, Add Project</button>
                                    </div>
                                </div>
                            </div>
                        </div>
