                ...
                <form method="POST" class="Post">
                    <div class="mb-3 profileDetails">
                        ...
                        <div class="col-12 col-md-8 shortBio mt-3">
                            <label for="shortbio" class="form-label">Short Description</label>
                            <textarea name="shortbio" class="form-control frm-sign" id="shortbio" required></textarea>
                        </div>
                    </div>
                    <div class="mb-3 personalDetail">
                        <label for="jobtitle" class="form-label">Job Title (Ex. Web Developer | Designer)</label>
                        <textarea name="jobtitle" class="form-control frm-sign" id="jobtitle" required></textarea>
                    </div>
                    <div class="mb-3 personalDetail">
                        <label for="longbio" class="form-label">Full Description about Yourself</label>
